...
# Wyciąganie słów kluczowych (tematów) - wyświetlenie wszystkich słów
topics = lda_model.print_topics(num_words=len(dictionary))  # Liczba słów odpowiada liczbie słów w słowniku
for topic in topics:
    print(topic)
